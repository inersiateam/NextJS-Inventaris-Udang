...
import {
  getLaporanStatsGuestAction,
  getChartLaporanGuestAction,
  getPembagianProvitGuestAction,
  getTopPelangganGuestAction,
  getChartBarangLaporanGuestAction,
} from "../actions/laporanGuestActions";
...
interface LaporanGuestClientProps {
...
export default function LaporanGuestClient({
  initialStats,
  initialChartLaporan,
    ...
    async (newPeriode: number) => {
      ...
      try {
        const [
          ...
          getLaporanStatsGuestAction(type, newPeriode),
          getChartLaporanGuestAction(type, newPeriode),
          getPembagianProvitGuestAction(type, newPeriode),
          getChartBarangLaporanGuestAction(type, newPeriode),
          ...barangTabs.map((barang) =>
            getTopPelangganGuestAction(type, barang.id, newPeriode)
          ),
        ]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <GuestNavbar guestType={type as "abl" | "atm"} />
