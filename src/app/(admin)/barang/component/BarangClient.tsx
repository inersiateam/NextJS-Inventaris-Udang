...
export default function BarangClient({ 
  ...
  const [barangList, setBarangList] = useState<BarangWithRelations[]>(initialData)
  ...
  const fetchBarang = async (resetPage = false) => {
    ...
    try {
      ...
      if (result.success && "data" in result && result.data) {
        ...
        const errorMsg = "error" in result ? result.error : "Gagal mengambil data"
            ...
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={4} className="text-center py-8 text-gray-500">
                  {search ? "Tidak ada data yang sesuai pencarian" : "Tidak ada data barang"}
                </TableCell>
              </TableRow>
            ) : (
